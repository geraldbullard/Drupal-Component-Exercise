...
class __TwigTemplate_f76252c6fd49240f2d3e7865ba6a7faffd32bbc2edba15b46ba11e358af58958 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
        // line 37
        $context["background_image"] = $this->extensions['Drupal\Core\Template\TwigExtension']->getFileUrl($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (($__internal_compile_0 = (($__internal_compile_1 = twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "field_media_image", [], "any", false, false, true, 37)) && is_array($__internal_compile_1) || $__internal_compile_1 instanceof ArrayAccess ? ($__internal_compile_1[0] ?? null) : null)) && is_array($__internal_compile_0) || $__internal_compile_0 instanceof ArrayAccess ? ($__internal_compile_0["#media"] ?? null) : null), "field_media_image", [], "any", false, false, true, 37), "entity", [], "any", false, false, true, 37), "uri", [], "any", false, false, true, 37), "value", [], "any", false, false, true, 37), 37, $this->source));
        // line 38
        echo "
<div";
        // line 39
...
";
    ...
    {
        return new Source("", "core/profiles/demo_umami/themes/umami/templates/components/banner-block/block--bundle--banner-block.html.twig", "H:\\ELYK\\www\\drupal\\public_html\\core\\profiles\\demo_umami\\themes\\umami\\templates\\components\\banner-block\\block--bundle--banner-block.html.twig");
    }
